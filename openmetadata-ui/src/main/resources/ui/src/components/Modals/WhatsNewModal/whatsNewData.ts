...
export const WHATS_NEW = [
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        title: 'Pipelines',
        description:
          'Pipelines are new entity addition to Simplidata. Add Airflow as a service ingest all pipelines metadata into Simplidata. Explore and Discover all your pipelines in single place.',
        isImage: false,
  ...
  },
  {
    ...
    features: [
      {
        ...
        description:
          'Simplidata captures the changes in metadata as new versions of an entity. The version history for all entities is maintained in the Major.Minor number.',
        isImage: false,
    ...
    changeLogs: {
      ...
      'Simplidata Quickstart':
        '- Shipped a Python package to simplify Simplidata docker installation.\n<code class="bg-grey-muted-lite text-grey-body font-medium">pip install openmetadata-ingestion[docker]\n\nmetadata docker --run</code>',
      'Helm Charts': `- Installing Simplidata in your cloud provider or on-premise got easier.\n- We worked on Helm charts to get the Simplidata and dependencies up and running on Kubernetes.`,
      'Other Features':
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Entities have a lot of user-generated metadata, such as descriptions, tags, ownership, tiering. There’s also rich metadata generated by Simplidata through the data profiler, usage data, lineage, test results, and other graph relationships with other entities. When an entity is deleted, all of this rich information is lost, and it’s not easy to recreate it. Now Simplidata supports soft deletion in the UI, and soft and permanent deletion in the API.',
        isImage: false,
      ...
      {
        title: 'Feature Tour',
        description: 'A tour of the key features in Simplidata 0.8.',
        isImage: false,
    ...
    features: [
      {
        ...
        description:
          'Collaboration is one of the founding principles behind Simplidata. The Simplidata 0.9 release focuses on Conversation Threads in the Activity Feed, Data Quality, and Glossary. We are iteratively building many important features based on community feedback.',
        isImage: false,
      ...
      },
      {
        ...
        description:
          'Simplidata now enables you to build a Glossary - a Controlled Vocabulary to describe important concepts and terminologies related to data within your organization to foster a common and consistent understanding of data.',
        isImage: false,
    ...
    features: [
      {
        ...
        description:
          'Simplidata has refactored the service connections to simplify the ingestion jobs from both the ingestion framework as well as the UI. We now use the pydantic models automatically generated from the JSON schemas for the connection definition. The ‘Add Service’ form is automatically generated in the UI based on the JSON schema specifications for the various connectors that are supported in Simplidata.',
        isImage: false,
      ...
      },
      {
        ...
        description:
          'Simplidata supports databases, service name databases, and tables. Based on community demand, we’ve also added Database Schema as part of the FQN. For each external data source, we ingest the database, as well as the tables that are contained underneath the schemas.',
        isImage: false,
      ...
      },
      {
        ...
        description:
          'Simplidata supported soft deletions. Now, we also support the hard deletion of entities through the UI, APIs, and ingestion. Hard deleting an entity removes the entity and all of its relationships. This will also generate a change event.',
        isImage: false,
        path: 'https://www.youtube.com/embed/6VILlkwQudo',
      },
    ],
    changeLogs: {
      'Backend APIs': `- **Fully Qualified Name (FQN) Separator:** Allows "." in the entity names and is handled as an internal detail in Simplidata. Improved the fullyQualifiedName. The "." is still the separator and the entity names from source will not be changed at all.\n- **Consistent FQN Changes** across the Simplidata UI, backend, Python framework, or any client that you might use.\n- **Introduced Database Schema as part of FQN:** For each external data source, we ingest the database, as well as the tables that are contained underneath the schemas. The database schema has been added into the hierarchy. Displays the fully qualified name, instead of a snippet of the table name.\n- **[Authorizer and Policy Changes](https://github.com/surenganne/OpenMetadata/issues/4199):** Enhanced flexibility for creating policies and assigning roles. The policies can be authored at a field level or domain level. \n- **User permissions** to update descriptions and tags will be dependent on the roles and permissions. One can create a role and provide the role permissions to update users in all teams.\n- **Supports Hard Deletion** of Entities through the UI, APIs, and ingestion: Hard deleting an entity removes the entity and all of its relationships. This will also generate a change event.`,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        title: 'Announcements',
        description:
          'With Announcements, you can now inform your entire team of all the upcoming events and changes. Simplidata supports these announcement banners for Entities or data assets like Tables, Topics, Pipelines, and Dashboards.',
        isImage: false,
      ...
      },
      {
        ...
        description:
          'The Simplidata Settings dropdown menu has been transformed into a single, centralized Settings page for added convenience in viewing all the available options. The Global Settings comprises setting options for Team Members, Access based on Roles and Policies, Services, Data Quality, Collaboration, Custom Attributes, and Integrations for webhooks and bots.',
        isImage: false,
      ...
      },
      {
        ...
        description:
          'Simplidata now supports adding custom properties for all entities, so organizations can tweak the data as per their needs.',
        isImage: false,
...
-   Simplidata supports SpEL (Spring Expression Language) based conditions.
...
-   The [Simplidata documentation](https://docs.open-metadata.org) site has been revamped.`,
    },
  },
  {
    id: 9,
...
- Admin can add new users and send an email`,
      ...
      'DBT Metadata - Tag': `- We support ingesting DBT tags into Simplidata.`,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'With the Simplidata UI, users can now create and deploy profiling workflows for the Data Lake connector, which supports AWS S3 and GCS.',
        isImage: false,
...
-   Admins can check for Daily active users and know how Simplidata is being used.
...
-   Bots can have their own policies. For example, the Ingestion Bot can create and update entities.`,
      'Advanced Search Improvements': `-   Apart from Simplidata's advanced search syntax which is syntax-driven, a **Syntax Editor** has been introduced.
...
-   Adding a [**custom service type**](https://docs.open-metadata.org/connectors/custom-connectors) supported from the 0.12.1 release.`,
      'Messaging Service Schemas': `-   We now parse **Avro** and **Protobuf Schemas** to extract the fields from **Kafka** and **Redpanda** Messaging services. Previously, the schemas were taken as one payload and just published to Simplidata.
...
- **Data Quality Tests** now support Data Lake services.`,
      ...
      'Airflow Lineage': `- **Airflow Lineage Operator** and the **Simplidata Hook** are now part of the ingestion package. Send Airflow metadata from your DAGs and safely store the Simplidata server connection directly in Airflow.`,
    },
  },
  {
    id: 12,
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Renamed Tag Categories to Classification, a more widely used term. Updated the API to conform with the rest of the specification. More info [here](https://github.com/surenganne/OpenMetadata/issues/9259).',
        isImage: true,
        path: tagCategoryImg,
      },
      {
      ...
      },
      {
        ...
        description: `Announcing the beta version of Simplidata Chrome extension.`,
        isImage: false,
...
- The import utility will validate the file and show you a preview of the elements that are going to be imported to Simplidata.`,
      'Unified Tag Category API': `- Renamed Tag Categories to Classification, a more widely used term.
- Updated the API to conform with the rest of the specification. More info [here](https://github.com/surenganne/OpenMetadata/issues/9259).`,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        title: 'Ingestion UI',
        description:
          'Connecting to your data sources has never been easier. With Simplidata 1.0, find all the necessary permissions and connection details directly in the UI.',
        isImage: false,
      ...
      },
      {
        title: 'Localization',
        description:
          'With more and more users from across the globe using Simplidata, we’ve added Localization Support in the UI. Now you can use Simplidata in English (US), French, Chinese, Japanese, Portuguese, and Spanish.',
        isImage: false,
      ...
      },
      {
        ...
        description:
          'The queries were already being ingested in the Usage Workflows in Simplidata.Now their presentation and overall user interaction has been improved. In the 1.0 release, users can manually enter the queries that they would like to share with the rest of their peers. They can also discuss and react to the other queries in each table.',
        isImage: false,
      ...
      },
      {
        ...
        description:
          'Previously, the Data Lake connector ingested one table per file, which covered only some of the use cases in a Data Platform. With the new Storage Services, you now have complete control over how you want to present your data lakes in Simplidata. The first implementation has been done on Amazon S3, wherein you can specify your tables and partitions and see them reflected with the rest of your metadata.',
        isImage: false,
      ...
      },
      {
        title: 'Glossary',
        description:
          'Simplidata, glossary, glossary UI, open source, glossary term, tags, classification, team hierarchy, metadata management.',
        isImage: false,
...
- New Apache Impala connector.`,
      'Storage Services': `- Based on your [feedback](https://github.com/surenganne/OpenMetadata/discussions/8124), we created a new service to extract metadata from your cloud storage.
...
- Users can now create and share a Query directly from the UI, linking it to multiple tables if needed.`,
      Localization: `- In 1.0, we have added Localization support for Simplidata.
- Now you can use Simplidata  in English, French, Chinese, Japanese, Portuguese,  and Spanish.`,
...
- Improved SQL parser to extract lineage in the Lineage Workflows.`,
      'Chrome Browser Extension': `- All the metadata is at your fingertips while browsing Looker, Superset, etc., with the Simplidata Chrome Browser Extension.
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          'Simplidata has redesigned Data Quality Tests to improve the end-user experience and prevent unnecessary duplication of tests. Data Quality Tests now have a Resolution Field. Users can acknowledge any errors, and once failures are resolved, they can document the resolution directly in the Simplidata UI.',
        isImage: false,
      ...
      },
      {
        title: 'PII Masking',
        description:
          'PII Masking capabilities have been introduced in Simplidata in the 1.1 Release. Admins and Asset Owners can view PII data, but other users cannot. PII sensitive sample data for Tables, Topics, Profiler Metrics, Test Cases, and Queries will be masked. This feature goes perfectly with the Auto-Tagging capability in Simplidata.',
        isImage: false,
...
`,
      'Data Quality': `- Redesigned [Data Quality Tests](https://github.com/surenganne/OpenMetadata/issues/11592) to improve the end-user experience and prevent unnecessary duplication of tests.
- Data Quality Tests now have a Resolution Field. Users can acknowledge any errors, and once failures are resolved, they can document the resolution directly in the Simplidata UI.
...
- Improved Snowflake Profiling performance of System Metrics.`,
      Ingestion: `- Improved [SQL Lineage Parsing](https://github.com/surenganne/OpenMetadata/issues/7427). We continue to share the OSS love by contributing to [sqllineage](https://github.com/reata/sqllineage) and [sqlfluff](https://sqlfluff.com/), the base libraries for our lineage features.
...
- Fixed dashboard description wrongly reported description as completed in the Data Insight.
      `,
      Connectors: `- New [Spline](https://absaoss.github.io/spline/) Connector to extract metadata and lineage from Spark jobs. Regardless of where the Spark execution happens, if you have configured the Spline Agent, we can send Spark metadata to Simplidata.
...
- Improved monitoring of the Pipeline Service Client health. Any status errors between the Simplidata server and the Pipeline Service Client are now surfaced in a Prometheus metric *pipelineServiceClientStatus_counter_total*
    ...
    features: [
      {
        title: 'Domain',
        description:
          'Simplidata 1.2.0 release now supports the creation of Domains. Assets can be added to a Domain, and users can scope their discovery experience to one Domain. Assets can also be added as Data Products in a Domain.',
        isImage: false,
      ...
      },
      {
        title: 'Data Products',
        description:
          'Simplidata 1.2.0 release now supports data products. Assets can be added as Data Products in a Domain.',
        isImage: false,
      ...
      },
      {
        ...
        description:
          'In the Simplidata 1.2.0 release, we support Search Index, Data Insights, and the Data Insights Report as applications. Each App represents an automation or a feature that acts on the metadata and can drive automation. Admins can install and setup the applications.',
        isImage: false,
      ...
      },
      {
        ...
        description:
          'Simplidata 1.2.0 release now supports the creation of Personas. Also, landing pages can be customized with widgets for various Personas. That way, you can ensure that the Simplidata landing page displays what is most important for a particular data team.',
        isImage: false,
...
- Assets can also be added as Data Products in a Domain.`,
      'Search Index': `- Elasticsearch or Open Search connectors can now bring in the search index metadata into Simplidata.
...
- Snowflake, Redshift, and BigQuery connectors are updated to bring stored procedure metadata into Simplidata.
...
- Color coding helps to visually differentiate and identify the data assets, when glossary terms are added to them.`,
      'Simplidata Browser Extension': `- Updated the Chrome browser extension for Simplidata with the new UI.
- Added support for Databases, Database Schemas, Tables, Dashboards, Charts, Pipelines, and Topics.`,
      'Build Automation Applications': `- Added Applications into Simplidata, giving users a unique view of processes that can be scheduled and run in the platform.
...
- Simplidata base server has been upgraded to Alpine 3.18.5.
    ...
    features: [
      {
        title: 'Settings UI',
        description:
          'Simplidata Settings page UI has been revamped to provide an intuitive and user-friendly interface.',
        isImage: false,
      ...
      },
      {
        title: 'RTL Support',
        description:
          'Simplidata now boasts support for ten languages, having expanded beyond English, French, Chinese, German, Japanese, Portuguese, Russian, and Spanish to include Hebrew and Dutch. To accommodate the Hebrew language, we have implemented substantial UI changes to ensure seamless RTL (right-to-left) support.',
        isImage: false,
      ...
      },
      {
        ...
        description:
          'Simplidata has enhanced profiling capabilities, so you can generate your own metrics using custom SQL. You can create custom metrics for the profiler at the Table and Column levels.',
        isImage: false,
      ...
      },
      {
        title: 'Knowledge Center (Exclusively for Collate)',
        description:
          'In the 1.3 release, Simplidata supports hierarchical pages to structure the articles for a cohesive view and access. Now, it is easier to associate the knowledge articles with data assets with just a few clicks.',
        isImage: false,
...
- Supports assigning a resolution task to the users in Simplidata.
...
- We now extract table descriptions when ingesting metadata from Salesforce.`,
      Glossary: `- Supports soft delete for the default glossaries in Simplidata.
...
- Simplidata can now handle metric history for ML models.
